...
import com.odoo.core.utils.Base64Helper;
import com.odoo.core.utils.ODateUtils;
import com.odoo.R;

public class MailRemoteViewFactory implements RemoteViewsFactory {

	public static final String TAG = MailRemoteViewFactory.class.getSimpleName();
	...
	public RemoteViews getViewAt(int position) {
		...
		//mView.setTextViewText(R.id.mail_date, ODateUtils.getDate(mContext, mCursor
		...
		bundle.putInt("com.odoo.widgets.EXTRA_WIDGET_DATA_VALUE",
	...
	public void onCreate() {
		if (OUser.current(mContext) == null)
			return;
		MailMessage message = new MailMessage(mContext, null);
