...
public class MailWidget extends AppWidgetProvider {
	...
	public static final String TAG = MailWidget.class.getSimpleName();
	...
	public void onReceive(Context context, Intent intent) {
		Log.d(TAG, "MailsWidget->onReceive()");
		if (intent.getAction().equals(ACTION_MESSAGE_WIDGET_CALL)) {
			...
			intentMain.putExtra("com.odoo.widgets.EXTRA_WIDGET_ITEM_KEY", "message_detail");
	...
	static void updateMessageWidget(Context context, AppWidgetManager manager,
		...
		for (int widget : widgetIds) {
			...
			Intent messageIntent = new Intent(context, OdooActivity.class);
			messageIntent.setAction(ACTION_MESSAGE_WIDGET_CALL);
			messageIntent.putExtra("com.odoo.widgets.EXTRA_WIDGET_ITEM_KEY",
					"message_main");
